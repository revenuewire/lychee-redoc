# Lychee API OpenAPI Specification
[![Build Status](https://travis-ci.org/revenuewire/lychee-redoc.svg?branch=master)](https://travis-ci.org/revenuewire/lychee-redoc)
...
6. If you did everything correct, https://revenuewire.github.io/lychee-redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://revenuewire.github.io/lychee-redoc/
- SwaggerUI: https://revenuewire.github.io/lychee-redoc/swagger-ui/
- Look full spec:
    + JSON https://revenuewire.github.io/lychee-redoc/swagger.json
    + YAML https://revenuewire.github.io/lychee-redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://revenuewire.github.io/lychee-redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://revenuewire.github.io/lychee-redoc/ with url from the message: `Server started <url>`
